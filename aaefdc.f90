...
1   FORMAT( '***********************************************************************************',/, &
  ...
  If( process_id == master_id )THEN !***Start calculation on master process
    ...
    write(7, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER

    OPEN(8,FILE=OUTDIR//'EFDCLOG.OUT', STATUS='REPLACE', SHARED)
    write(8, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER

    OPEN(9,FILE=OUTDIR//'TIME.LOG', STATUS='REPLACE')
    write(9, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER
    CLOSE(9)
      
    OPEN(11976,FILE='GHG\WQCDFX.OUT', STATUS='REPLACE')  !SWWCGHG
    write(11976, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER
    write(11976,'(2A6,A23,A7,2A11,A14,A10,A17,4A14)') 'I','J','CO2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','pH','POC_mine','CH4oxidwc','Denit','HR','Algae'
    
    OPEN(76119,FILE='GHG\WQMTHFX.OUT', STATUS='REPLACE')  !SWWCGHG
    write(76119, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER
    write(76119,'(2A6,A23,A7,2A11,A14,2A13,2A14)') 'I','J','CH4FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JCH4G','JCH4AQ','CH4SAT','CH4REF'
    
    OPEN(1999,FILE='GHG\WQN2OFX.OUT', STATUS='REPLACE')  !SWWCGHG
    write(1999, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER
    write(1999,'(2A6,A23,A7,2A11,A14,A13,3A14)') 'I','J','N2OFLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2OAQ','JNO2N2ON','JNO2N2OD','JN2ON2'
    
    OPEN(0706,FILE='GHG\WQN2FX.OUT', STATUS='REPLACE')  !SWWCGHG
    write(0706, '(33("*"),/,"*** EFDC+ Version: ",A10," ***",/,33("*"))') EFDC_VER
    write(0706,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2AQ'

	OPEN(16881,FILE='GHG\CO2_NH.OUT', STATUS='REPLACE')  !SWWCGHG
    WRITE(16881, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=NH",/,33("*"))') EFDC_VER
    WRITE(16881,'(2A6,A23,A7,2A11,A14,A10,A17,A14)') 'I','J','CO2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','pH','POC_mine','CH4_oxid'
    OPEN(16882,FILE='GHG\CH4_NH.OUT', STATUS='REPLACE')
    WRITE(16882, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=NH",/,33("*"))') EFDC_VER
    WRITE(16882,'(2A6,A23,A7,2A11,A14,2A13,2A14)') 'I','J','CH4FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JCH4G','JCH4AQ','CH4SAT','CH4REF'
    OPEN(16883,FILE='GHG\N2O_NH.OUT', STATUS='REPLACE')
    WRITE(16883, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=NH",/,33("*"))') EFDC_VER
    WRITE(16883,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2OFLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2OAQ'
    OPEN(16884,FILE='GHG\N2_NH.OUT', STATUS='REPLACE')
    WRITE(16884, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=NH",/,33("*"))') EFDC_VER
    WRITE(16884,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2AQ'

    
	OPEN(27641,FILE='GHG\CO2_HW.OUT', STATUS='REPLACE')  !SWWCGHG
    WRITE(27641, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HW",/,33("*"))') EFDC_VER
    WRITE(27641,'(2A6,A23,A7,2A11,A14,A10,A17,6A14)') 'I','J','CO2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','pH','POC_mine','CH4_oxid','CH4oxidwc','Denit','HR','Algae','FCH4AVG'   !SWWCGHG
    OPEN(27642,FILE='GHG\CH4_HW.OUT', STATUS='REPLACE')
    WRITE(27642, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HW",/,33("*"))') EFDC_VER
    WRITE(27642,'(2A6,A23,A7,2A11,A14,2A13,2A14)') 'I','J','CH4FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JCH4G','JCH4AQ','CH4SAT','CH4REF' !SWWCGHG
    OPEN(27643,FILE='GHG\N2O_HW.OUT', STATUS='REPLACE')
    WRITE(27643, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HW",/,33("*"))') EFDC_VER
    WRITE(27643,'(2A6,A23,A7,2A11,A14,6A13)') 'I','J','N2OFLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2OAQ','CNO2','TNO2N2ON','TNO2N2OD','TN2ON2'
    OPEN(27644,FILE='GHG\N2_HW.OUT', STATUS='REPLACE')
    WRITE(27644, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HW",/,33("*"))') EFDC_VER
    WRITE(27644,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2AQ'
    OPEN(27645,FILE='GHG\SEDIMENT_HW.OUT', STATUS='REPLACE')
    WRITE(27645, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HW",/,33("*"))') EFDC_VER
    WRITE(27645,'(3A6,12A14)') 'I','J','TIME','SMPOC1','SMPOC2','SMPON1','SMPON2','SM1NH4','SM2NH4','SM1NO3','SM2NO3','WQBFNH4','WQBFNO3','WQBFO2','DOKSZ'
    
	OPEN(33121,FILE='GHG\CO2_DB.OUT', STATUS='REPLACE')  !SWWCGHG
    WRITE(33121, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=DB",/,33("*"))') EFDC_VER
    WRITE(33121,'(2A6,A23,A7,2A11,A14,A10,A17,A14)') 'I','J','CO2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','pH','POC_mine','CH4_oxid'
    OPEN(33122,FILE='GHG\CH4_DB.OUT', STATUS='REPLACE')
    WRITE(33122, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=DB",/,33("*"))') EFDC_VER
    WRITE(33122,'(2A6,A23,A7,2A11,A14,2A13,2A14)') 'I','J','CH4FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JCH4G','JCH4AQ','CH4SAT','CH4REF'
    OPEN(33123,FILE='GHG\N2O_DB.OUT', STATUS='REPLACE')
    WRITE(33123, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=DB",/,33("*"))') EFDC_VER
    WRITE(33123,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2OFLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2OAQ'
    OPEN(33124,FILE='GHG\N2_DB.OUT', STATUS='REPLACE')
    WRITE(33124, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=DB",/,33("*"))') EFDC_VER
    WRITE(33124,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2AQ'
    
	OPEN(26041,FILE='GHG\CO2_HYD.OUT', STATUS='REPLACE')  !SWWCGHG
    WRITE(26041, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HYD",/,33("*"))') EFDC_VER
    WRITE(26041,'(2A6,A23,A7,2A11,A14,A10,A17,A14)') 'I','J','CO2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','pH','POC_mine','CH4_oxid'
    OPEN(26042,FILE='GHG\CH4_HYD.OUT', STATUS='REPLACE')
    WRITE(26042, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HYD",/,33("*"))') EFDC_VER
    WRITE(26042,'(2A6,A23,A7,2A11,A14,2A13,2A14)') 'I','J','CH4FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JCH4G','JCH4AQ','CH4SAT','CH4REF'
    OPEN(26043,FILE='GHG\N2O_HYD.OUT', STATUS='REPLACE')
    WRITE(26043, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HYD",/,33("*"))') EFDC_VER
    WRITE(26043,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2OFLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2OAQ'
    OPEN(26044,FILE='GHG\N2_HYD.OUT', STATUS='REPLACE')
    WRITE(26044, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=HYD",/,33("*"))') EFDC_VER
    WRITE(26044,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2AQ'
    
    
	OPEN(28541,FILE='GHG\CO2_BH.OUT', STATUS='REPLACE')  !SWWCGHG
    WRITE(28541, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=BH",/,33("*"))') EFDC_VER
    WRITE(28541,'(2A6,A23,A7,2A11,A14,A10,A17,A14)') 'I','J','CO2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','pH','POC_mine','CH4_oxid'
    OPEN(28542,FILE='GHG\CH4_BH.OUT', STATUS='REPLACE')
    WRITE(28542, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=BH",/,33("*"))') EFDC_VER
    WRITE(28542,'(2A6,A23,A7,2A11,A14,2A13,2A14)') 'I','J','CH4FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JCH4G','JCH4AQ','CH4SAT','CH4REF'
    OPEN(28543,FILE='GHG\N2O_BH.OUT', STATUS='REPLACE')
    WRITE(28543, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=BH",/,33("*"))') EFDC_VER
    WRITE(28543,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2OFLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2OAQ'
    OPEN(28544,FILE='GHG\N2_BH.OUT', STATUS='REPLACE')
    WRITE(28544, '(33("*"),/,"*** EFDC+ Version: ",A10," ***   Site=BH",/,33("*"))') EFDC_VER
    WRITE(28544,'(2A6,A23,A7,2A11,A14,A13)') 'I','J','N2FLUX-g/(m2*day)','Kw','Cobs','Ceq','TIME','JN2AQ'
    
    OPEN(76, file="wqcsrpH.inp")  !SWWCGHG
    OPEN(0119,FILE='wqghg.inp')
  ...
  countDay = 0 !SWWCGHG: Temporary variable for GHG output
